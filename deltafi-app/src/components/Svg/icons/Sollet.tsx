...
interface SolletProps extends SvgProps {
  isAccept?: boolean;
}
const Icon: React.FC<SolletProps> = ({ isAccept, ...props }) => {
  return (
    <Svg width="60" height="60" viewBox="0 0 530 530" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g>
        <path
          fill={isAccept ? "#00FFA3" : "rgb(200, 200, 200, 0.8)"}
